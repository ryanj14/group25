...
<html lang="en">
   ...
   <body>
    <script src="Styles/contact.js">
      ...
      <main>
         <div class="video">
            <iframe src="https://www.youtube.com/embed/f8bMDZrfOwo?list=PLuMTZBpxpB0cB3p3ewQT3KTdZ6szpBYSZ" allowfullscreen></iframe>
         </div>
         <div class="details">
            <p><b>Detail Information:<br></b>ARMA 3 is a military tactical shooter video game developed and published by Bohemia Interactive.
			It was released for Microsoft Windows in September 2013, and later for OS X and Linux in August 2015. ARMA 3's storyline takes place in 
			the mid-2030s during the fictional Operation Magnitude, a military operation launched by NATO forces fighting in Europe against "Eastern 
			armies" referred to as Canton-Protocol Strategic Alliance Treaty (CSAT), led by a resurgent Iranian military with a coalition of other Middle
			Eastern and Asian nations.
			<br>This video above is a ARMA 3 gameplay vadio that made by a famous youtuber call Franky.
            </p>
         </div>
