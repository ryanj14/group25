   ...
   <script src="Styles/contact.js">
      ...
      <main>
         <div class="news">
            <div class="nintendo">
               <div class="overlap">
                  <span class="Enter"><a href="Nintendo.php">ENTER</a></span>
               </div>
            </div>
            <p class="center2">April 10, 2017</p>
            <h3 class="center">Nintendo Direct 4.12.2017</h3>
            <p>Nintendo has announced the next Nintendo Direct.</p>
         </div>
         <div class="news">
            <div class="alex">
               <div class="overlap">
                  <span class="Enter"><a href="Alex.php">ENTER</a></span>
               </div>
            </div>
		 ...
		 <div class="news">
            <div class="cyberpunk">
               <div class="overlap">
                  <span class="Enter"><a href="Cyberpunk2077.php">ENTER</a></span>
               </div>
            </div>
